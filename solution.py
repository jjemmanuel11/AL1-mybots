...
class SOLUTION:
    ...
    def Create_World(self):
        ...
        pyrosim.Send_Cube(name="Block", pos=[0,0,2] , size=[0.5,0.5,0.5])
        pyrosim.End()
    ...
    def Create_Body(self):
        ...
        #FRONT LEG
        pyrosim.Send_Joint(name = "Torso_FrontLeg" , parent= "Torso" , child = "FrontLeg" , type = "revolute", position = [0.5,0.5,1], jointAxis="1 0 0")
        ...
        #BACK LEG
        pyrosim.Send_Joint(name = "Torso_BackLeg" , parent= "Torso" , child = "BackLeg" , type = "revolute", position = [0.5, -.5, 1], jointAxis= "1 0 0")
        pyrosim.Send_Cube(name="BackLeg", pos=[0.5, -0.5, 0] , size=[.2,1,.2])

        pyrosim.Send_Joint(name = "BackLeg_BackLowerLeg" , parent= "BackLeg" , child = "BackLowerLeg" , type = "revolute", position = [0.5,-1,0], jointAxis="1 0 0")
