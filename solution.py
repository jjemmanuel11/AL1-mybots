...
class SOLUTION:
    ...
    def Create_World(self):
        ...
        pyrosim.Send_Cube(name="Block", pos=[-3,-2.5,0.5] , size=[1,1,1])
        pyrosim.Send_Cube(name="Block", pos=[-5,4,0.5] , size=[1,1,1])
        pyrosim.Send_Cube(name="Block", pos=[-4,2,0.5] , size=[1,1,1])
        pyrosim.Send_Cube(name="Block", pos=[-6,-2,0.5] , size=[1,1,1])
        pyrosim.Send_Cube(name="Block", pos=[-8,-1,0.5] , size=[1,1,1])
        pyrosim.Send_Cube(name="Block", pos=[-10,-2,0.5] , size=[1,1,1])
        pyrosim.End()
